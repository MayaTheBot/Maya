...
import net.puffinmay.maya.interactions.InteractionCommandContext
import net.puffinmay.maya.interactions.components.ComponentId
...
class InteractionsListener(private val instance: MayaInstance) : ListenerAdapter() {
