...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("kotlinx-coroutines-debug", "org.jetbrains.kotlinx", "kotlinx-coroutines-debug").version(
                kotlinxCoroutines
            )
            ...
            library("exposed-core", "org.jetbrains.exposed", "exposed-core").version("0.61.0")
            library("exposed-dao", "org.jetbrains.exposed", "exposed-dao").version("0.61.0")
            library("exposed-jdbc", "org.jetbrains.exposed", "exposed-jdbc").version("0.61.0")
            ...
            // Serialization
            library("kotlinx-serialization-core", "org.jetbrains.kotlinx", "kotlinx-serialization-core").versionRef(
                kotlinxSerialization
            )
            library("kotlinx-serialization-json", "org.jetbrains.kotlinx", "kotlinx-serialization-json").versionRef(
                kotlinxSerialization
            )
            library("kotlinx-serialization-hocon", "org.jetbrains.kotlinx", "kotlinx-serialization-hocon").versionRef(
                kotlinxSerialization
            )
            library(
