...
abstract class SassTask : DefaultTask() {
    ...
    fun execute() {
        ...
        val url = when {
            ...
            else -> "https://github.com/sass/dart-sass/releases/download/$sassVersion/dart-sass-$sassVersion-macos-x64.tar.gz"
        }
        ...
        if (!dartSassOsTempFolder.exists()) {
            ...
            @Suppress("DEPRECATION") val sass = URL(url).readBytes()
