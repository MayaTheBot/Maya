...
dependencies {
    ...
    implementation(project(":maya-website:frontend"))
...
val sass = tasks.register<SassTask>("sass-style-scss") {
    this.inputSass.set(file("src/main/scss/style.scss"))
    this.inputSassFolder.set(file("src/main/scss/"))
    this.outputSass.set(file("$buildDir/scss/style-scss"))
}

@Suppress("DEPRECATION")
val globalSass = tasks.register<SassTask>("sass-global-style-scss") {
    this.inputSass.set(file("src/main/scss/global.scss"))
    this.inputSassFolder.set(file("src/main/scss/"))
    this.outputSass.set(file("$buildDir/scss/style-scss"))
}
