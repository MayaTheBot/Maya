...
import net.puffinmay.maya.utils.serializable.cluster.ClusterInfo
import net.puffinmay.maya.utils.serializable.cluster.CustomGuildInfo
import net.puffinmay.maya.utils.serializable.cluster.CustomMemberResponse
...
object ClusterUtils {
    ...
    fun getClusterByShardId(instance: MayaInstance, shardId: Int): MayaConfig.DiscordSettings.Cluster {
    ...
    suspend fun MayaInstance.getMemberFromGuild(
        instance: MayaInstance,
        guildId: String,
        memberId: Long
    ...
    suspend fun MayaInstance.getGuildInfo(instance: MayaInstance, guildId: Long): CustomGuildInfo? {
    ...
    suspend fun MayaInstance.getMemberRolesFromGuildOrCluster(
        instance: MayaInstance,
        guildId: Long,
        memberId: Long
    ): List<String> {
    ...
    suspend fun MayaInstance.getClusterInfo(cluster: MayaConfig.DiscordSettings.Cluster): ClusterInfo? {
        return try {
