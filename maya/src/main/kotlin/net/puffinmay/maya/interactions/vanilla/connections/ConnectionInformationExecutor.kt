...
import net.puffinmay.maya.database.data.CountConnectionsByName
...
class ConnectionInformationExecutor : UnleashedCommandExecutor() {
    override suspend fun execute(context: CommandContext) {
        ...
        val embed = EmbedBuilder {
            ...
            field {
                name = "${MayaEmotes.world} ${context.locale["connections.info.connectionLanguage"]}"
            ...
            field {
                name = "${MayaEmotes.calendar} ${context.locale["connections.info.connectionCreated"]}"
            ...
            field {
                name = "${MayaEmotes.crown} ${context.locale["connections.info.connectionOwner"]}"
