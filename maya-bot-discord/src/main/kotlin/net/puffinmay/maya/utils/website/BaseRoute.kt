package net.puffinmay.maya.utils.website
...
abstract class BaseRoute(
    ...
    fun install(r: Route) {
        ...
        val builder: Route.(String, suspend RoutingContext.(MayaLocale) -> Unit) -> Unit =
            { path, block ->
    ...
    private suspend fun RoutingContext.resolveLocale(requiresLang: Boolean): MayaLocale? {
    ...
    protected abstract suspend fun handle(context: RoutingContext)
