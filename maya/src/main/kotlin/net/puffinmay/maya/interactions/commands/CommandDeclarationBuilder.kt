...
class CommandDeclarationBuilder(
    ...
    companion object {
        private val enUsLocale = MayaLocale("en-us")
        private val ptBrLocale = MayaLocale("pt-br")

        private fun getTranslation(locale: MayaLocale, key: String, fallback: String): String {
